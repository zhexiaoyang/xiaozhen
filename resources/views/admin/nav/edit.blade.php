...
@section("content")
    ...
    <form action="{{url('admin/nav/'.$nav->id)}}" id="form_sample_2" novalidate="novalidate" method="post">
        {{csrf_field()}}
        ...
        <div class="form-body">
            <div class="form-group form-md-line-input @if($errors->has('name')) has-error @endif">
                ...
                <span class="input-group-addon">
                    ...
                    <input type="text" class="form-control"  name="name" value="{{$nav->name}}" placeholder="请输入导航名称...">
            ...
            <div class="form-group form-md-line-input @if($errors->has('title')) has-error @endif">
                ...
                <span class="input-group-addon">
                    ...
                    <input type="text" class="form-control"  name="title" value="{{$nav->title}}" placeholder="请输入导航标题...">
            ...
            <div class="form-group form-md-line-input @if($errors->has('url')) has-error @endif">
                ...
                <span class="input-group-addon">
                    ...
                    <input type="text" class="form-control"  name="url" value="{{$nav->url}}" placeholder="请输入导航地址...">
            ...
            <div class="form-group form-md-line-input @if($errors->has('sort')) has-error @endif">
                ...
                <span class="input-group-addon">
                    ...
                    <input type="text" class="form-control"  name="sort" value="{{$nav->sort}}" placeholder="请输入导航排序...">
            ...
            <div class="form-group form-md-line-input">
                <select class="form-control" name="status">
                    <option value="1" @if($nav->status === 1) selected @endif>正常</option>
                    <option value="0" @if($nav->status === 0) selected @endif>禁用</option>
                    <option value="-1" @if($nav->status === -1) selected @endif>删除</option>
                </select>
