...
@section("content")
    ...
    <form action="{{url('admin/config')}}" id="form_sample_2" novalidate="novalidate" method="post">
        {{csrf_field()}}
        <div class="form-body">
            <div class="form-group form-md-line-input @if($errors->has('name')) has-error @endif">
                ...
                <span class="input-group-addon">
                    ...
                    <input type="text" class="form-control"  name="name" value="{{old('name')}}" placeholder="请输入配置名称...">
            ...
            <div class="form-group form-md-line-input @if($errors->has('title')) has-error @endif">
                ...
                <span class="input-group-addon">
                    ...
                    <input type="text" class="form-control"  name="title" value="{{old('title')}}" placeholder="请输入配置标题...">
            ...
            <div class="form-group form-md-radios">
                ...
                <div class="md-radio-inline">
                    <div class="md-radio">
                        <input type="radio" id="input" name="type" class="md-radiobtn" value="input"  checked="checked">
                        <label for="input">
                            <span class="inc"></span>
                    ...
                    <div class="md-radio">
                        <input type="radio" id="radio" name="type" class="md-radiobtn" value="radio">
                        <label for="radio">
                            <span class="inc"></span>
                            <span class="check"></span>
                    ...
                    <div class="md-radio">
                        <input type="radio" id="textarea" name="type" class="md-radiobtn" value="textarea">
                        <label for="textarea">
                            <span class="inc"></span>
                            <span class="check"></span>
            ...
            {{--<div class="form-group form-md-line-input @if($errors->has('content')) has-error @endif">--}}
                ...
                {{--</span>--}}
                    ...
                    {{--<label for="form_control_1">配置内容</label>--}}
            ...
            <div class="form-group form-md-line-input @if($errors->has('sort')) has-error @endif">
                ...
                <span class="input-group-addon">
                    ...
                    <input type="text" class="form-control"  name="sort" value="{{old('sort',100)}}" placeholder="请输入配置排序...">
