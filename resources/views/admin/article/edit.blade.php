...
@section("content")
    ...
    <h1 class="page-title"> 更新文章
        {{--<small>添加后台文章</small>--}}
    </h1>
    <div class="page-title">
        <a class="btn btn-success" href="{{url('admin/article')}}">文章列表</a>
    </div>
    <form action="{{url('admin/article/'.$article->id)}}" novalidate="novalidate" method="post">
        {{csrf_field()}}
        ...
        <div class="form-body">
            <div class="form-group form-md-line-input">
                ...
                {!! $articleRepository->topArticleSelect($article->cid) !!}
            </div>
            <div class="form-group form-md-line-input @if($errors->has('title')) has-error @endif">
                ...
                <span class="input-group-addon">
                    ...
                    <input type="text" class="form-control"  name="title" value="{{$article->title}}" placeholder="请输入文章标题...">
            ...
            <div class="form-group form-md-line-input @if($errors->has('description')) has-error @endif">
                ...
                <span class="input-group-addon">
                    ...
                    <input type="text" class="form-control"  name="description" value="{{$article->description}}" placeholder="请输入文章描述...">
            ...
            <div class="form-group form-md-line-input @if($errors->has('keyword')) has-error @endif">
                ...
                <span class="input-group-addon">
                    ...
                    <input type="text" class="form-control"  name="keyword" value="{{$article->keyword}}" placeholder="请输入关键字...">
            ...
            <div class="form-group form-md-line-input @if($errors->has('editor')) has-error @endif">
                ...
                <span class="input-group-addon">
                    ...
                    <input type="text" class="form-control"  name="editor" value="{{$article->editor}}" placeholder="请输入文章作者...">
            ...
            <div class="form-group form-md-line-input @if($errors->has('sort')) has-error @endif">
                ...
                <span class="input-group-addon">
                    ...
                    <input type="text" class="form-control"  name="sort" value="{{$article->sort}}" placeholder="请输入文章排序...">
                    <label for="form_control_1">文章排序<span class="required" aria-required="true"></span></label>
                    @if($errors->has('sort'))
            ...
            <div class="form-group form-md-radios">
                ...
                <div class="md-radio-inline">
                    <div class="md-radio">
                        <input type="radio" id="radio6" name="front_show" class="md-radiobtn" value="1" @if($article->is_rec === 1) checked @endif>
                        <label for="radio6">
                            <span class="inc"></span>
                    ...
                    <div class="md-radio">
                        <input type="radio" id="radio7" name="front_show" class="md-radiobtn" value="0" @if($article->is_rec === 0) checked @endif>
                        <label for="radio7">
                            <span class="inc"></span>
                            <span class="check"></span>
            ...
            <div class="form-group form-md-line-input">
                <select class="form-control" name="status">
                    <option value="1" @if($article->status === 1) selected @endif>正常</option>
                    <option value="0" @if($article->status === 0) selected @endif>禁用</option>
                    <option value="-1" @if($article->status === -1) selected @endif>删除</option>
                </select>
            ...
            @if($article->img_url)
                var html = '\
                        <div class="img_item">\
                            ...
                            <input type="hidden" name="img_name" value="{{$article->img_name}}">\
                            <span class="img_main"></span>\
                            <span class="img_close" onclick="closeImg(this)"></span>\
                        </div>\
                        ';
