...
@section("content")
    ...
    <form action="{{url('admin/role/'.$role->id)}}" novalidate="novalidate" method="post">
        {{csrf_field()}}
        ...
        <div class="form-body">
            ...
            <div class="form-group form-md-line-input @if($errors->has('display_name')) has-error @endif">
                ...
                <span class="input-group-addon">
                    ...
                    <input type="text" class="form-control"  name="display_name" value="{{$role->display_name}}" placeholder="请输入角色标题...">
                    <label for="form_control_1">角色标题<span class="required" aria-required="true">*</span></label>
            ...
            <div class="form-group form-md-line-input @if($errors->has('description')) has-error @endif">
                ...
                <span class="input-group-addon">
                    ...
                    <input type="text" class="form-control"  name="description" value="{{$role->description}}" placeholder="请输入角色描述...">
            ...
            <div class="form-group form-md-line-input @if($errors->has('sort')) has-error @endif">
                ...
                <span class="input-group-addon">
                    ...
                    <input type="text" class="form-control"  name="sort" value="{{$role->sort}}" placeholder="请输入角色排序...">
            ...
            <div class="form-group form-md-line-input">
                <select class="form-control" name="status">
                    ...
                    <option value="-1" @if($role->status === -1) selected @endif>删除</option>
                </select>
