...
@section("content")
    ...
    <form action="{{url('admin/category')}}" id="form_sample_2" novalidate="novalidate" method="post">
        {{csrf_field()}}
        <div class="form-body">
            <div class="form-group form-md-line-input">
                @inject('categoryRepository','App\Repositories\admin\CategoryRepository')
                {!! $categoryRepository->topCategorySelect() !!}
            </div>
            <div class="form-group form-md-line-input @if($errors->has('name')) has-error @endif">
                ...
                <span class="input-group-addon">
                    ...
                    <input type="text" class="form-control"  name="name" value="{{old('name')}}" placeholder="请输入分类名称...">
            ...
            <div class="form-group form-md-line-input @if($errors->has('title')) has-error @endif">
                ...
                <span class="input-group-addon">
                    ...
                    <input type="text" class="form-control"  name="title" value="{{old('title')}}" placeholder="请输入分类标题...">
            ...
            <div class="form-group form-md-line-input @if($errors->has('description')) has-error @endif">
                ...
                <span class="input-group-addon">
                    ...
                    <input type="text" class="form-control"  name="description" value="{{old('description')}}" placeholder="请输入分类描述...">
            ...
            <div class="form-group form-md-line-input @if($errors->has('keywprd')) has-error @endif">
                ...
                <span class="input-group-addon">
                    ...
                    <input type="text" class="form-control"  name="keywprd" value="{{old('keywprd')}}" placeholder="请输入分类关键字...">
                    <label for="form_control_1">分类关键字</label>
            ...
            <div class="form-group form-md-line-input @if($errors->has('sort')) has-error @endif">
                ...
                <span class="input-group-addon">
                    ...
                    <input type="text" class="form-control"  name="sort" value="{{old('sort',100)}}" placeholder="请输入分类排序...">
            ...
            <div class="form-group form-md-radios">
                ...
                <div class="md-radio-inline">
                    <div class="md-radio">
                        <input type="radio" id="radio6" name="front_show" class="md-radiobtn" value="1">
                        <label for="radio6">
                            <span class="inc"></span>
                    ...
                    <div class="md-radio">
                        <input type="radio" id="radio7" name="front_show" class="md-radiobtn" value="0" checked="checked">
                        <label for="radio7">
                            <span class="inc"></span>
                            <span class="check"></span>
