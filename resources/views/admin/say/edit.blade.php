...
@section("content")
    ...
    <h1 class="page-title"> 更新说说
        {{--<small>添加后台说说</small>--}}
    </h1>
    <div class="page-title">
        <a class="btn btn-success" href="{{url('admin/say')}}">说说列表</a>
    </div>
    <form action="{{url('admin/say/'.$say->id)}}" novalidate="novalidate" method="post">
        {{csrf_field()}}
        ...
        <div class="form-body">
            <div class="form-group form-md-line-input @if($errors->has('title')) has-error @endif">
                ...
                <span class="input-group-addon">
                    ...
                    <input type="text" class="form-control"  name="title" value="{{$say->title}}" placeholder="请输入说说标题...">
            ...
            <div class="form-group form-md-line-input @if($errors->has('sort')) has-error @endif">
                ...
                <span class="input-group-addon">
                    ...
                    <input type="text" class="form-control"  name="sort" value="{{$say->sort}}" placeholder="请输入说说排序...">
                    <label for="form_control_1">说说排序<span class="required" aria-required="true"></span></label>
                    @if($errors->has('sort'))
            ...
            <div class="form-group form-md-radios">
                ...
                <div class="md-radio-inline">
                    <div class="md-radio">
                        <input type="radio" id="radio6" name="front_show" class="md-radiobtn" value="1" @if($say->is_rec === 1) checked @endif>
                        <label for="radio6">
                            <span class="inc"></span>
                    ...
                    <div class="md-radio">
                        <input type="radio" id="radio7" name="front_show" class="md-radiobtn" value="0" @if($say->is_rec === 0) checked @endif>
                        <label for="radio7">
                            <span class="inc"></span>
                            <span class="check"></span>
            ...
            <div class="form-group form-md-line-input">
                <select class="form-control" name="status">
                    <option value="1" @if($say->status === 1) selected @endif>正常</option>
                    <option value="0" @if($say->status === 0) selected @endif>禁用</option>
                    <option value="-1" @if($say->status === -1) selected @endif>删除</option>
                </select>
            ...
            <div class="form-group form-md-line-input @if($errors->has('content')) has-error @endif">
                ...
                <span class="input-group-addon">
                    ...
                    <textarea class="form-control" name="content" rows="3">{{$say->content}}</textarea>
        ...
        $(document).ready(function() {
            ...
            @if($say->img_url)
                var html = '\
                        <div class="img_item">\
                            <img src="{{$say->img_url}}">\
                            <input type="hidden" name="img_url" value="{{$say->img_url}}">\
                            <input type="hidden" name="img_name" value="{{$say->img_name}}">\
                            <span class="img_main"></span>\
                            <span class="img_close" onclick="closeImg(this)"></span>\
                        </div>\
                        ';
