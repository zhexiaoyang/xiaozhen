...
class CategoryController extends CommonController
{
    public function show($cid=0)
    {
        ...
        {
            $category = '全部分类';
            $articles = Article::statusEq1()->select('id','cid','img_url','title','description','created_at','view')->orderBy('created_at','desc')->paginate(9);
        }else{
            ...
            $articles = Article::statusEq1()->select('id','cid','img_url','title','description','created_at','view')->whereIn('cid',$cids)->orderBy('created_at','desc')->paginate(9);
        }
